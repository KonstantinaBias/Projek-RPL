 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Pengajuan Surat Mahasiswa</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <br>    
      ...
      <tr>
        ...
        $no =1;
      include "../koneksi.php";
      $data = mysqli_query($kon,"select * from surat where lain='mahasiswa'");
      ...
      <td><?php echo $d['tujuan']; ?> </td>
          ...
          <a href="ubah.php?id=<?php echo $d['id']; ?>"><button class="btn btn-success">Setujui</button></a></td>
        </tr>
        <?php } ?>
    </table>
