 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Konfirmasi Surat Mahasiswa</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <br>    
      ...
      <tr>
        ...
        $no =1;
      include "../koneksi.php";
      $data = mysqli_query($kon,"SELECT * from surat where lain='mahasiswa' and status='Setuju' ");
      while($d = mysqli_fetch_array($data)){
        ...
        <tr>
          ...
          <td>
          <a href="feedback.php?id=<?php echo $d['id']; ?>"><button class="btn btn-success">Beri Konfirmasi</button></a></td>
        </tr>
        <?php } ?>
    </table>
